defmodule MainProxyDemoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MainProxyDemoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MainProxyDemoWeb.Gettext, "errors", msg, opts)
    end
  end
